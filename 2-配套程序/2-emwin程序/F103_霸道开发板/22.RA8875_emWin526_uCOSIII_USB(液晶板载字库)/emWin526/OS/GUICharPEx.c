...
void GUIPROP_X_DispChar(U16P c) 
{
    ...
    if (pProp)
    {
		...
		RA8875_SetDispWin(GUI_pContext->DispPosX,GUI_pContext->DispPosY,32,32);
...
//			BTE_Wait();	
		...
		//printf("XDist=%d,DispPosX=%d,,DispPosY=%d\n",pCharInfo->XDist,GUI_pContext->DispPosX,GUI_pContext->DispPosY);
    }		
}
/*********************************************************************
