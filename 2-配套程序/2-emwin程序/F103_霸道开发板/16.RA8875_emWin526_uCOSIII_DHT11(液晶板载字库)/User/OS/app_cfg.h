...
#define  APP_TASK_SCREENSHOT_PRIO                  3u
#define  APP_TASK_GUIKEYPAD_PRIO                   4u
#define  APP_TASK_GUI_PRIO                         OS_CFG_PRIO_MAX-4u
...
#define  APP_TASK_SCREENSHOT_STK_SIZE		512u
#define  APP_TASK_GUIKEYPAD_STK_SIZE		512u
#define  APP_TASK_GUI_STK_SIZE				4*1024u
